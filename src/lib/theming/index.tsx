...
export function createTheming<Them extends ThemeConfig<any, any, any, any>>( themeConfig:Them ) {
  ...
  return {
    themeConfig,
    createStylesHook: themedCreateStylesHook,
    useTheme: jssUseTheme,
    ThemeProvider( props:Omit<ThemeProviderProps<typeof themeConfig>, "themeConfig"> ) {
      return <ThemeProvider themeConfig={themeConfig} {...props} />
    },
  }
}
