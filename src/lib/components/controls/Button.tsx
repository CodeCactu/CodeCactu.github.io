...
export default function Button({ children, body, className, style, type, disabled, linkRel, onClick, wide, href, ariaLabel, ariaCurrent, variant = `contained` }:ButtonProps) {
  children ||= body
