...
export default class CactuBlinkingLines {
  uiData = {}
  lines: Line[] = []
  ...
  constructor( canvas:HTMLCanvasElement ) {
    ...
    this.loop.startLoop( timeMult => this.update( timeMult ) )
    ...
    document.addEventListener( `visibilitychange`, () => {
      if (document.hidden) this.loop.pauseLoop()
      else this.loop.resumeLoop()
    } )
  }
